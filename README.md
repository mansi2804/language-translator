...
<ol>
  ...
  <li>Specify the target language code (e.g., <code>en</code> for English, <code>es</code> for Spanish).</li>
...
<p>Contributions are welcome! If you have suggestions for improvements or find bugs, feel free to fork the repository and submit a pull request. Please follow the standard coding guidelines when contributing.</p>
